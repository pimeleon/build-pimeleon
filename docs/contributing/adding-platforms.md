...
export PIMELEON_PLATFORM=orangepi
export PIMELEON_MODEL=5-plus
...
```
output/
├── pimeleon-20250106-143022.img          # 4GB image file
...
qemu-system-aarch64 \
  ...
  -drive if=none,file=output/pimeleon-*.img,format=raw,id=hd \
...
- **Issues**: [GitHub Issues](https://github.com/yourorg/pimeleon-build/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourorg/pimeleon-build/discussions)
