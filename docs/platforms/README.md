...
# Raspberry Pi 4B
PIROUTER_PLATFORM=raspberrypi PIROUTER_MODEL=4B make build
...
for model in 3B+ 4B; do
  PIROUTER_PLATFORM=raspberrypi PIROUTER_MODEL=$model make build
done
```
...
### Community
- [GitHub Discussions](https://github.com/yourorg/pi-router-build/discussions)
- [GitHub Issues](https://github.com/yourorg/pi-router-build/issues)
